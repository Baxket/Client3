...
curl --header "Content-Type: application/json" --request POST --data '{"deviceDesc": {"rulesetIDs": "57c8e0e9-dbf9-314a-b985-ea431ec6b6f6","password":"'"$2"'","username":"'"$1"'"},"key":"client"}' https://tvwsclient.herokuapp.com/MS/test2.php >Slave_init_resp.html
